...
using CMS_Solution.WebRuby.Seo;
namespace CMS_Solution.WebRuby.Infrastructure
{
    public partial class GenericUrlRouteProvider : IRouteProvider
    {
        public void RegisterRoutes(RouteCollection routes)
        {
            ...
            routes.MapLocalizedRoute("MD_MANUFACTURER",
                            "{SeName}",
            ...
            routes.MapLocalizedRoute("Topic",
                            ...
                            new[] { "Nop.Web.Controllers" });
            routes.MapLocalizedRoute("RecruitmentItem",
                          "{SeName}",
                          new { controller = "Common", action = "RecruitmentItem" },
                          new[] { "Nop.Web.Controllers" });
            routes.MapLocalizedRoute("GymSetupItem",
                          "{SeName}",
                          new { controller = "GymSetup", action = "GymSetupItem" },
                          new[] { "Nop.Web.Controllers" });
